					...
					<div class="panel-body">
						<div class="user-info">
						    <div class="form-line">
						        ...
						        <input type="password" id="oldPassword" name="oldPassword" autocomplete="off" onkeyup="ruleOldPwdKeyUp(${user.password})"/>
						    ...
						    <div class="form-line">
						        ...
						        <input class="input" type="password" id="password-confirm" autocomplete="off" />
						        <span id="apwd_span"></span>
						    </div>
						    <a href="javascript:submit('user/updatePwd.do')" class="btn btn-submit">提交</a>
						</div>
					</div>
				</div>
			</div>
