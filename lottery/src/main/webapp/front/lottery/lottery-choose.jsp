  ...
  <body>
	   <jsp:include page="/front/top.jsp"></jsp:include>
		...
		<div class="crumb">
			<div class="w">
				<div class="crumb-con">
					...
					<span>&gt;</span>
					<span class="link-text">购买彩票</span>
				</div>
			</div>
		</div>
		...
		<div class="w page-wrap">
			<h3 class="news-title">双色球</h3>
			<div class="ssq_area">
				<div class="select_ball_area">
					<div class="redball_area">
						<div  class="redball_rule"><strong>红球区</strong>选择6个球</div>
					...
					<div class="blueball_area">
						<div  class="blueball_rule"><strong>蓝球区</strong>选择1个球</div>
						<ul id="blueBall">
							<li><p>01</p></li>  
							<li><p>02</p></li>  
							<li><p>03</p></li>  
						...
						<div class="machine_blueselected_area">
