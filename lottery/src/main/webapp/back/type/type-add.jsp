	...
	<form id="typeForm" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="lotypename">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="lotterdate" class="select">
					...
					<option value="一、二、四">一、二、四</option>
					<option value="一、二、五">一、二、五</option>
					<option value="一、二、六">一、二、六</option>
					<option value="一、二、日">一、二、日</option>
					<option value="二、三、四">二、三、四</option>
					<option value="二、三、五">二、三、五</option>
					<option value="二、三、六">二、三、六</option>
					<option value="二、三、日">二、三、日</option>
					<option value="三、四、五">三、四、五</option>
					<option value="三、四、六">三、四、六</option>
					<option value="三、四、日">三、四、日</option>
					<option value="四、五、六">四、五、六</option>
					<option value="四、五、日">四、五、日</option>
					<option value="五、六、日">五、六、日</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="salemoney">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="lottertime" id="" placeholder="格式为 时:分 如09:00" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>彩种描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="lotypedesc" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<a onClick="jumpFun()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</a>
